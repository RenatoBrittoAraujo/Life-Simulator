...
public:
	...
	void eatCheck(Life *entityEater);

	virtual Life *newEntityInstance(Rectangle<int> areaToAdd) = 0;
   ...
   */
	...
	std::vector<Life*>& getEntities() { return this->_entities; }
...
protected:
	...
	std::vector<Life*> _entities;
	std::vector<GameObject*> _entitiesObjects;

	void storeEntity(Life* entity);
